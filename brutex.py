# /bin/python !
# https://github.com/ProudPakistanie/
...
\033[1;91m<═══\033[1;41m\033[1;97m Created by Sahil Shah Gillani\033[;0m\033[1;91m═══>\033[1;92m""")
...
\033[1;97m➤ \033[1;92mTool BruteX is created by SS GILLANI
\033[1;92m""")
	...
	if menu == '01' or menu == '1':
		...
		while True:
			...
			if fol == '1' or fol == '01':
				...
				time.sleep(1)
				os.system("xdg-open https://facebook.com/ProudPakistanie")

			elif fol == '3' or fol == '03':
				print()
				print("\033[1;91m[*] \033[1;97mOpening my Github profile in your device \n")
				time.sleep(1)
				os.system("xdg-open https://github.com/ProudPakistanie")
